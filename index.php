    ...
    <div class=container>
        ...
        <div class="collapse navbar-collapse" id=myNavbar>
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="view/client/SaisieClient.php">SIGN UP</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<div id=services class="container">
    ...
    <div class="row slideanim">
        <div class=col-md-3>
            ...
            <img src=img/Ordi_portable.jpg alt="NEW" class="full" width=200 height=200>
            <h4>Ordinateurs portables</h4>
            <p>Discover our Products..</p>
        </div>
        <div class=col-md-3>
            <!--   <span class="glyphicon glyphicon-heart logo-small"></span>-->
            <img src=img/Ordi_bureau.jpg alt="NEW" class="full" width=200 height=200>
            <h4>Ordinateurs de bureau</h4>
            <p>Discover our Products..</p>
        </div>
        <div class=col-md-3>
            <!--  <span class="glyphicon glyphicon-lock logo-small"></span> -->
            <img src=img/tablette.jpeg alt="NEW" class="full" width=200 height=200>
            <h4>Tablettes tactiles</h4>
            <p>Discover our Products..</p>
        </div>
        <div class=col-md-3>
            <!--<span class="glyphicon glyphicon-off logo-small"></span>-->
            <img src=img/casque.jpg alt="NEW" class="full" width=200 height=200>
    ...
    <div class="row slideanim">
        <div class=col-sm-3>
            ...
            <img src=img/nova3i.jpg alt="NEW" class="full" width=200 height=200>
            <h4>Smartephones</h4>
            <p>Discover our Products..</p>
        </div>
        <div class=col-sm-3>
            <!--  <span class="glyphicon glyphicon-certificate logo-small"></span> -->
            <img src=img/kit.jpg alt="NEW" width=200 class="full" height=200>
            <h4>Accessoires Téléphoniques</h4>
            <p>Discover our Products..</p>
        </div>
        <div class=col-sm-3>
            <!--  <span class="glyphicon glyphicon-certificate logo-small"></span> -->
            <img src=img/imprimante.jpg alt="NEW" width=200 class="full" height=200>
            <h4>Imprimantes</h4>
            <p>Discover our Products..</p>
        </div>
        <div class=col-sm-3>
            <!--  <span class="glyphicon glyphicon-wrench logo-small"></span> -->
            <img src=img/scanner.jpg alt="NEW" width=200 class="full" height=200>
    ...
    <div class="row slideanim">
        <div class="col-sm-4 col-xs-12">
            <div class="panel panel-default text-center">
                ...
                <div class=panel-body>
                    <img src="view/client/images/me.jpg" width="200px">
                </div>
        ...
        <div class="col-sm-4 col-xs-12">
            <div class="panel panel-default text-center">
                ...
                <div class=panel-body>
                    <img src="view/client/images/najwa.jpg" width="200px" height="230px">
                </div>
                <div class=panel-footer>
        ...
        <div class="col-sm-4 col-xs-12">
            <div class="panel panel-default text-center">
                ...
                <div class=panel-body>
                    <img src="view/client/images/imen.jpg" width="200px" height="230">
                </div>
                <div class=panel-footer>
				...
				<div class="col-md-8">
					...
					<div class="col-md-4 col-sm-4 col-xs-6">
						<ul class="fh5co-footer-links">
							...
							<li>Periphériques et Accessoires</li>
					...
					<div class="col-md-4 col-sm-4 col-xs-6">
						<ul class="fh5co-footer-links">
							<li>Smartphones</li>
							<li>Accessoires Téléphoniques</li>
							<li>Imprimantes</li>
							<li>Scanner</li>
					...
					<h3>Contact</h3>
						...
						<li><span class="glyphicon glyphicon-map-marker"></span> Tunisia,Sfax</li>
							...
							<li><span class="glyphicon glyphicon-cloud"></span><a href="https://gi1s1.azurewebsites.net/?fbclid=IwAR12c8bWwQ6gD565pZiUFiFigVR9VCwr5CzV3oI24ykXVPovg1KsTonXEYo#portfolio"> Retrouvez-nous sur Azure</a></li>
						</ul>
					</div>
				</div>
			</div>
